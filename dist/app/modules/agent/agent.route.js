...
router.post('/add-money', (0, checkAuth_1.checkAuth)(user_interface_1.Role.AGENT), agent_controller_1.addMoney);
router.post('/withdraw', (0, checkAuth_1.checkAuth)(user_interface_1.Role.AGENT), agent_controller_1.withdraw);
